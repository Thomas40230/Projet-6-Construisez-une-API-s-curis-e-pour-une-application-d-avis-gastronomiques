...
const sauceSchema = mongoose.Schema({
  ...
  heat: { type: Number, required: true }, // nombre entre 1 et 10 décrivant le piquant de la sauce
  ...
  usersLiked: { type: [String], default: 0 }, // tableau des identifiants des utilisateurs qui ont aimé (= liked) la sauce
  usersDisliked: { type: [String], default: 0 }, // tableau des identifiants des utilisateurs qui n'ont pas aimé (= disliked) la sauce
});
